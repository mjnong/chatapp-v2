...
extern "C" JNIEXPORT jlong JNICALL Java_com_edgeai_chatappv2_GenieWrapper_loadModel(JNIEnv* env,
                                                                                   jobject /* this */,
...
extern "C" JNIEXPORT void JNICALL Java_com_edgeai_chatappv2_GenieWrapper_getResponseForPrompt(JNIEnv* env,
                                                                                             jobject /* this */,
...
extern "C" JNIEXPORT void JNICALL Java_com_edgeai_chatappv2_GenieWrapper_freeModel(JNIEnv* env,
                                                                                  jobject /* this */,
                                                                                  jlong genie_wrapper_handle)
{
    try
